# Lesson 25 · Observability and cost discipline
...
2. **Eval pass rate.** The eval suite you wrote in Lesson 10, run on every deployment, with the trend visible over time. A drop is a leading indicator something broke.
...
2. Route easy work to small or local models (Lesson 0.5). Reserve frontier APIs for the genuinely hard cases.
...
The pattern: in your discovery doc (Lesson 23), commit to a target cost-per-active-user. In your weekly update (Lesson 24), report against it. Every customer conversation about cost is easier when you brought the number first.
...
Next: [Lesson 26 · Security and compliance for AI products](26-security-and-compliance.html)
