...
You've built a real thing, shipped it, and put instrumentation around it — evals, a no-slop pass, a design spec, a second brain. That's the whole loop. From here it's depth, not new fundamentals.
...
Don't learn those from a list. Learn them when a project needs them. Here's a ladder, each rung one notch harder than the last:
...
Each rung stresses one course skill harder than the rest. That's the point — you find the weak spot by walking into it on purpose.
...
Be honest about the timeline. This is a transition, not a tool install. The first couple of weeks feel slower — you're writing briefs for work you used to just start, and that friction is real. It doesn't stay. By around week eight it isn't a tool you reach for. It's how you work. The way to get there isn't more reading. It's the next project, and the one after that.
